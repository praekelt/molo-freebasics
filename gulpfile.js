...
var sassPaths = [
    'freebasics/styles/style.scss',
    'freebasics/styles/enhanced.scss',
];

var sassDest = {
     prd: 'freebasics/static/css/prd',
     dev: 'freebasics/static/css/dev'
};
...
gulp.task('watch', function() {
    livereload.listen();
    gulp.watch('freebasics/styles/*.scss', ['styles']);
});
